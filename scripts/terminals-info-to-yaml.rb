...
terminal_type = ARGV.shift()    # This might be 'vax' or 'alpha' etc.
terminal_info = ARGV.shift()    # This is the systems .info file
...
terminals = TerminalsCollection.create_from_info_file(terminal_info, terminal_type, tags, refs, pubs)
